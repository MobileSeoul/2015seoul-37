...
public class Cm extends FragmentActivity {
    ...
    private void initialisePaging() {
        ...
        fregments.add(Fragment.instantiate(this, CSpring.class.getName()));
        fregments.add(Fragment.instantiate(this, Csummer.class.getName()));
        fregments.add(Fragment.instantiate(this, Cfall.class.getName()));
        fregments.add(Fragment.instantiate(this, Cwinter.class.getName()));
